...
CREATE TABLE IF NOT EXISTS Dog     (collarid INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, age INT, name VARCHAR(32), gender VARCHAR(1), own INT UNSIGNED, breedid INT UNSIGNED, date_birth DATE DEFAULT CURRENT_DATE);
